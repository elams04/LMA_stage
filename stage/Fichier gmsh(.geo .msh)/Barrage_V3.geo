...
h=12800; h2=340; H=h+h2 ; b=220; lb=110; l=13600; L=2*l+2*lb+b;
c=12800;
cb=12800;
p=12800; couchep=15;
pbarrage=10;couchepbarrage=5;
...
Physical Volume("PML_x-y-z-",4) = {105};
Physical Volume("PML_x-y-",5) = {18, 41, 52};
Physical Volume("PML_x-z-",6) = {100,101,102,103};
Physical Volume("PML_x-",7) = {19, 20, 21, 22, 42, 43, 44, 45, 48, 49, 50, 51};
Physical Volume("PML_x+",8) = {10, 11, 12, 13, 33, 34, 35, 36, 65, 66, 67, 68};
Physical Volume("PML_z+",9) = {70, 71, 72, 73, 74, 75, 76, 77, 78};
Physical Volume("PML_z-",10) = {92,93,94,95,96,97,98,99,104};
Physical Volume("PML_y-",11) = {15, 16, 17, 38, 39, 40, 53, 59, 60};
Physical Volume("PML_x+y-",12) = {14, 37, 69};
Physical Volume("PML_y-z-",13)={106,107,108};
Physical Volume("PML_y-z+",14) = {84, 85, 86};
Physical Volume("PML_x-z+",15) = {88, 89, 90, 91};
Physical Volume("PML_x+z-",16)={110,111,112,113};
Physical Volume("PML_x+z+",17) = {79, 80, 81, 82};
Physical Volume("PML_x-y-z+",18) = {87};
Physical Volume("PML_x+y-z+",19) = {83};
Physical Volume("PML_x+y-z-",20)={109};
Physical Volume("PMLeau",21) = {114};
