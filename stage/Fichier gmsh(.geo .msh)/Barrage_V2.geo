// Gmsh project created on Fri Nov 08 11:58:59 2024
// Definition des variables et du parametre du niveu de l eau
h=24700; h2=200; H=h+h2 ; b=400; lb=25; l=13600; L=2*l+2*lb+b;
c=12000;
cb=24700;
p=12800; couchep=15;
pbarrage=15;couchepbarrage=5;
avant=12785;coucheavant=9;
niveaubarrage=130;
a1=3; a2=9; a3=15; a4=15;
b1=8; b2=8; b3=7; b4=8; b5=8;
...
pmlAvant[]=Extrude {0, 0, pml} {
  Surface{1556,1534,1512,1490,1578,1644,1666,1688,1710,1732,1754,1776,1798,1820,1622,1600,1468,1446,1424,1358,1380,1402}; Layers{couchepml,1};Recombine;
}; 

pmlArrier=Extrude {0, 0, -pml} {
  Surface{500,478,456,434,412,346,368,390,786,764,742,720,324,698,676,654,632,610,588,566,544,522,808}; Layers{couchepml,1}; Recombine; 
};

Physical Volume("PMLavant1",4) = {70, 71, 72, 73, 74, 75, 76, 77, 78};
Physical Volume("PMLavant2",5) = {88, 89, 90, 91};
Physical Volume("PMLavant3",6) = {87};
Physical Volume("PMLavant4",7) = {84, 85, 86};
Physical Volume("PMLavant5",8) = {83};
Physical Volume("PMLavant6",9) = {79, 80, 81, 82};
Physical Volume("PMLarriere1",10) = {92,93,94,95,96,97,98,99,104};
Physical Volume("PMLarriere2",11) = {100,101,102,103};
Physical Volume("PMLarriere3",12) = {105};
Physical Volume("PMLarriere4",13)={106,107,108};
Physical Volume("PMLarriere5",14)={109};
Physical Volume("PMLarriere6",15)={110,111,112,113};
Physical Volume("PMLeau",16) = {114};
Physical Volume("PMLgauche",17) = {19, 20, 21, 22, 42, 43, 44, 45, 48, 49, 50, 51};
Physical Volume("PMLgauche-",18) = {18, 41, 52};
Physical Volume("PMLdroite-",19) = {14, 37, 69};
Physical Volume("PMLdroite",20) = {10, 11, 12, 13, 33, 34, 35, 36, 65, 66, 67, 68};
Physical Volume("PMLbas",21) = {15, 16, 17, 38, 39, 40, 53, 59, 60};

i=4;
For(4:21)
   Color Green{ Physical Volume{i}; }
   i++;
EndFor
